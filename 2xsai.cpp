...
SDL_Surface *SDL_Scale_2xSai(SDL_Surface *src)
{
	SDL_Rect rect;
	rect.x=0;rect.y=3;rect.h=src->h+6;rect.w=src->w;
...
//		amask = 0x0000;
//	#endif  
	SDL_Surface *source=SDL_CreateRGBSurface(SDL_SWSURFACE, src->w, src->h+6, 16, rmask, gmask, bmask, amask);
	SDL_BlitSurface(src, NULL, source, &rect);
	SDL_Surface *dest=SDL_CreateRGBSurface(SDL_SWSURFACE, src->w*2, 2*src->h+12, 16, rmask, gmask, bmask, amask);
		...
		amask = 0xff000000;
	#endif  
	SDL_Surface *dest2=SDL_CreateRGBSurface(SDL_SWSURFACE, src->w*2, 2*src->h, 32, rmask, gmask, bmask, amask);
	Uint8 *sx = (Uint8*)source->pixels + source->pitch * 3;
	Uint8 *dx = (Uint8*)dest->pixels + dest->pitch * 3;
	Init_2xSaI(565);
	_2xSaI(sx, source->pitch, dx, dest->pitch, source->w, source->h-6);
	SDL_FreeSurface(source);
	rect.y=3;rect.w=src->w*2;rect.h=src->h*2;
	SDL_BlitSurface(dest, &rect, dest2, NULL);
	SDL_FreeSurface(dest);
	return dest2;	
}
SDL_Surface *SDL_Scale_Super2xSai(SDL_Surface *src)
{
	SDL_Rect rect;
	rect.x=0;rect.y=3;rect.h=src->h+6;rect.w=src->w;
	Uint32 rmask, gmask, bmask, amask;
...
//	#endif  
	...
	Uint8 *dx = (Uint8*)dest->pixels + dest->pitch * 3;
	Init_2xSaI(565);
	Super2xSaI(sx, source->pitch, dx, dest->pitch, source->w, source->h-6);
	SDL_FreeSurface(source);
	rect.y=3;rect.w=src->w*2;rect.h=src->h*2;
	SDL_BlitSurface(dest, &rect, dest2, NULL);
	SDL_FreeSurface(dest);
...
SDL_Surface *SDL_Scale_SuperEagle(SDL_Surface *src)
{
	SDL_Rect rect;
	rect.x=0;rect.y=3;rect.h=src->h+6;rect.w=src->w;
	Uint32 rmask, gmask, bmask, amask;
...
//	#endif  
	...
	Uint8 *dx = (Uint8*)dest->pixels + dest->pitch * 3;
	Init_2xSaI(565);
	SuperEagle(sx, source->pitch, dx, dest->pitch, source->w, source->h-6);
	SDL_FreeSurface(source);
	rect.y=3;rect.w=src->w*2;rect.h=src->h*2;
	SDL_BlitSurface(dest, &rect, dest2, NULL);
	SDL_FreeSurface(dest);
